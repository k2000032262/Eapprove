...
<body>{
					...
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								<center><h2>Welcome to login</h2>
								<center><p>Don't have an account?</p>
								<center><a href="Register.jsp" class="btn btn-white btn-outline-white">Sign Up</a>
							</div>
			      </div>
						<div class="login-wrap p-4 p-lg-5">
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<center><h3 class="mb-4">Sign In</h3>
			      		</div>
								<div class="w-100">
    ...
    <form class="signin-form" action="Approvalhome.html">
		            ...
		            <div class="form-group">
		            	<center><button type="submit" class="form-control btn btn-primary submit px-3">Sign In</button>
		            </div>
		            <div class="form-group d-md-flex">
		            	<div class="w-50 text-left">
			            	<center><label class="checkbox-wrap checkbox-primary mb-0">Remember Me
